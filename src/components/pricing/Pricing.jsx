  ...
  const items = [
    {
      key: "1",
      label: "Luxury",
      children: "A luxurious home design combines elegance and functionality, using high-quality materials like marble, hardwood, and sleek metals. Sophisticated lighting, spacious layouts, and custom details such as bespoke furniture create a refined, timeless aesthetic, offering both comfort and a sense of grandeur.",
    },
    {
      key: "2",
      label: "Classic",
      children: "Classic home design exudes timeless elegance, characterized by rich materials, intricate details, and a warm color palette. Features like ornate moldings, hardwood floors, and vintage furnishings create a sense of sophistication and charm. Traditional elements such as chandeliers, antique decor, and grand fireplaces enhance the inviting atmosphere, while symmetrical layouts provide balance and harmony. This style emphasizes comfort and craftsmanship, making each space feel both luxurious and welcoming. Classic design celebrates history and artistry, ensuring that a home remains both stylish and functional for generations to come.",
    },
    {
      key: "3",
      label: "Elegant",
      children: "Elegant home design focuses on simplicity and sophistication, characterized by clean lines, neutral color palettes, and high-quality materials. This style incorporates minimalist furniture and refined decor, creating a serene atmosphere. Large windows allow natural light to flood the space, enhancing its openness. Thoughtful details, such as tasteful artwork and stylish lighting fixtures, add charm without overwhelming the design. The emphasis on functionality ensures that each element serves a purpose while maintaining aesthetic appeal, resulting in a harmonious environment that exudes modern luxury and timeless grace.3",
    },
  ];
